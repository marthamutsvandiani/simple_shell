...
/**
 * _env_get_key - gets the value of an environment variable
...
/**
 * _env_set_key - overwrite the value of the environment variable
...
/**
 * _env_remove_key - remove a key from the environment
...
/**
 * _print_environ - prints the current environ
